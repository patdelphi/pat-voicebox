    ...
    <>
      ...
      <div className="max-w-md mx-auto h-full flex items-center">
        <div className="flex flex-col items-center text-center space-y-5">
          ...
          <FadeIn delay={300}>
            <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
              <span>{t('settings.about.enhancedBy')}</span>
              <a
                href="https://github.com/patdelphi"
                target="_blank"
                rel="noopener noreferrer"
                className="text-accent hover:underline"
              >
          ...
          <FadeIn delay={380}>
            <div className="flex flex-wrap justify-center gap-3 pt-2">
              ...
              <a
                href="https://github.com/patdelphi/pat-voicebox"
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 rounded-lg border border-border/60 px-4 py-2 text-sm transition-colors hover:bg-muted/50"
              >
                ...
                {t('settings.about.projectGitHub')}
                <ArrowUpRight className="h-3.5 w-3.5 text-muted-foreground/40 group-hover:text-muted-foreground transition-colors" />
              </a>
            </div>
          </FadeIn>
              ...
              <Trans
                ...
                components={{
                  link: (
                    ...
                    <a
                      href="https://github.com/patdelphi/pat-voicebox/blob/main/LICENSE"
                      target="_blank"
                      rel="noopener noreferrer"
